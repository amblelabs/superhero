...
public class TimelessEntityTypes {
    ...
    public static final EntityType<BatmobileEntity> BAT_MOBILE = register(Registries.ENTITY_TYPE, "bat_mobile", EntityType.Builder.<BatmobileEntity>create(BatmobileEntity::new, SpawnGroup.MISC)
            .setDimensions(3f, 1.8f)
            .build("bat_mobile"));
